...
Route::middleware(['admin'])->group(function () {
    ...
    Route::patch('/admin/{user}/set-writer', [AdminController::class, 'setWriter'])->name('admin.setWriter');
                                    //REJECT
    Route::patch('/admin/{user}/reject-admin', [AdminController::class, 'rejectAdmin'])->name('admin.rejectAdmin');
    Route::patch('/admin/{user}/reject-revisor', [AdminController::class, 'rejectRevisor'])->name('admin.rejectRevisor');
    Route::patch('/admin/{user}/reject-writer', [AdminController::class, 'rejectWriter'])->name('admin.rejectWriter');
                                    //TAG ROUTES
